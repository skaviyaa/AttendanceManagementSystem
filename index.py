...
window.geometry('1536x994')

bg = PhotoImage(file = "simg.png")
...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Label(ec, text='Please enter your department name!!!', fg='red', bg='white', font=('times', 16, ' bold ')).pack()
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def err_screen1():
                ...
                Label(errsc2, text='Please enter Employee Name & ID!!!', fg='red', bg='white',
            ...
            ENR = tk.Label(MFW, text="Enter Employee id ", width=15, height=2, fg="black",
                           font=('times', 17, ' bold '))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Employee name", width=18, height=2, fg="black",
                                font=('times', 17, ' bold '))
            ...
            def create_csv():
                ...
                for col in reader:
                    ...
                    for row in col:
                        ...
                        label = tk.Label(root, width=13, height=1, fg="black", font=('times', 13, ' bold '),
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\admin\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance"')
    ...
    SUB = tk.Label(sb, text="Enter Department", width=15, height=2, fg="white", bg="blue2", font=('times', 15, ' bold '))
...
def err_screen():
    ...
    Label(sc1,text='Employee id & Name required!!!',fg='red',bg='white',font=('times', 16, ' bold ')).pack()
...
def err_screen1():
    ...
    Label(sc2,text='Please enter your Employee name!!!',fg='red',bg='white',font=('times', 16, ' bold ')).pack()
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            csvFile = open('EmployeeDetails/EmployeeDetails.csv', 'a+') 
...
def subjectchoose():
    ...
    sub = tk.Label(windo, text="Enter Department", width=15, height=2, fg="white", bg="blue2", font=('times', 15, ' bold '))
    sub.place(x=30, y=100)
    ...
    def log_in():
        ...
        if username == 'goms' :
            if password == '123':
                ...
                cs = './EmployeeDetails/EmployeeDetails.csv'
                file=open(cs, newline="")
                reader = csv.reader(file)
                r = 0
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Employee ID", width=20, height=2, fg="white", bg="royalblue", font=('times', 15, ' bold '))
...
lbl2 = tk.Label(window, text="Enter Name", width=20, fg="white", bg="royalblue", height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, fg="red", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

clearButton = tk.Button(window, text="Clear",command=clear,fg="black"  ,bg="deepskyblue"  ,width=10  ,height=1 ,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="black"  ,bg="deepskyblue"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton1.place(x=950, y=310)

AP = tk.Button(window, text="Check Employee details",command=admin_panel,fg="black"  ,bg="darkturquoise"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
